...
export const metadata: Metadata = {
  ...
  description:
    "The months before construction begins are where your custom home is actually made. Here's what the preconstruction process looks like in Toronto.",
};
      ...
      <section className="relative py-32 md:py-40">
        <div className="max-w-3xl mx-auto px-8 md:px-16">
          <ScrollReveal>
            ...
            <p className="text-white/40 text-sm font-light">February 2026</p>
          </ScrollReveal>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-8 md:px-16">
          <ScrollReveal>
            <div className="prose-custom">
              <p>
                Everyone pictures the exciting part &mdash; watching the framing
                go up, seeing the kitchen take shape, walking through the
                finished home for the first time. But the months before a single
                shovel hits the ground are where your custom home is actually
                made. This is preconstruction, and it&apos;s the phase most
                homeowners underestimate.
              </p>
              <p>
                At Fatahi Building, preconstruction is where we spend the most
                time thinking. It&apos;s deliberate. Because every decision made
                here &mdash; from the foundation design to the window placement
                to the plumbing layout &mdash; determines whether the build goes
                smoothly or becomes a series of expensive surprises.
              </p>
              ...
              <p>
                How do you use your kitchen &mdash; do you cook together, or is
                one person the chef? Do your kids need a playroom now that
                becomes a media room in five years? Do you work from home? Do you
                want to see the backyard from the kitchen? Do you entertain, and
                if so, is it ten people for dinner or fifty for a party?
              </p>
              <p>
              ...
              <p>
                ...
                back with a design that reflects what we heard &mdash; not a
                template we&apos;ve used before.
              </p>
              ...
              <p>
                ...
                report early. Toronto&apos;s soil varies dramatically &mdash;
                clay in one neighbourhood, rock in another. The soil determines
                the foundation type, which affects cost and timeline.
              </p>
              <p>
                ...
                floor-to-ceiling glass is beautiful &mdash; until it&apos;s 35
                degrees in July and you can&apos;t stand in your own kitchen.
              </p>
              <p>
              ...
              <p>
                ...
                finished design &mdash; we develop it with you.
              </p>
              <p>
              ...
              <p>
                ...
                &mdash; because we&apos;re designing both at the same time.
              </p>
              <p>
              ...
              <p>
                ...
                countertops, cabinetry, tile, fixtures, hardware &mdash; the
                number of decisions is significant. We guide you through this
                with a clear framework: durability, maintenance, aesthetics, and
                budget. Not every premium material is the right choice for every
                room.
              </p>

              <h2>Permits &mdash; The Part Nobody Loves</h2>
              <p>
              ...
              <ul>
                <li>
                  <strong>Building permit:</strong> Typically 8&ndash;16 weeks
                ...
                <li>
                  ...
                  for minor variances &mdash; if you need a slightly deeper
                  setback or more lot coverage than zoning allows. Adds
                  2&ndash;4 months.
                </li>
                <li>
              ...
              <p>
                ...
                6-month project &mdash; from first meeting to move-in,
                14&ndash;20 months is realistic depending on size and complexity.
              </p>
              ...
              <p>
                ...
                &mdash; assuming no changes to the scope. There&apos;s no
                &ldquo;we&apos;ll figure it out during construction.&rdquo;
                Everything is decided before we start.
              </p>

              <h2>Why This Phase Takes Time</h2>
              <p>
                Preconstruction for a custom home typically takes 3&ndash;5
                months. That can feel slow when you&apos;re eager to see your
                home take shape. But consider the alternative: rushing into
                construction with unresolved design questions, incomplete
                engineering, or a vague scope leads to change orders, delays, and
                the feeling that you&apos;re making $10,000 decisions on the
                spot.
              </p>
              <p>
                ...
                becomes an execution of a plan &mdash; not an improvisation.
              </p>
