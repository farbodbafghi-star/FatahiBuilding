      ...
      <section className="relative h-[70vh] min-h-[500px] flex items-end">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 md:px-16 pb-16 w-full">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl md:text-5xl font-light font-heading text-white leading-tight tracking-wide">Terrace</h1>
          </div>
        </div>
      </section>
          ...
          <ScrollReveal>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-28">
              ...
              <div className="lg:col-span-8">
                <h2 className="text-2xl md:text-3xl font-light font-heading text-white tracking-wide mb-6">Warmth meets sophistication</h2>
        ...
        <div className="max-w-7xl mx-auto px-8 md:px-16">
          ...
          <div className="columns-1 md:columns-2 gap-4 space-y-4">
            {galleryImages.map((img, i) => (
              <ScrollReveal key={img.src} delay={(i % 2) * 150}>
                <div className="break-inside-avoid overflow-hidden group">
                  <Image src={img.src} alt={img.alt} width={800} height={i % 2 === 0 ? 600 : 750} className="w-full h-auto object-cover transition-transform duration-700 group-hover:scale-105" sizes="(max-width: 768px) 100vw, 50vw" />
                </div>
              </ScrollReveal>
            ))}
          </div>
